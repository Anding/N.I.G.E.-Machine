...
set_property PACKAGE_PIN T15 [get_ports CLK_SDRAM]					
	set_property IOSTANDARD LVCMOS33 [get_ports CLK_SDRAM]
#Bank = 14, Pin name = IO_L23P_T3_A03_D19_14,				Sch name = CRAM_ADVN
set_property PACKAGE_PIN T13 [get_ports ADV_SDRAM]					
	set_property IOSTANDARD LVCMOS33 [get_ports ADV_SDRAM]
#Bank = 14, Pin name = IO_L4P_T0_D04_14,					Sch name = CRAM_CEN
set_property PACKAGE_PIN L18 [get_ports CE_SDRAM]					
	set_property IOSTANDARD LVCMOS33 [get_ports CE_SDRAM]
#Bank = 15, Pin name = IO_L19P_T3_A22_15,					Sch name = CRAM_CRE
set_property PACKAGE_PIN J14 [get_ports CRE_SDRAM]					
	set_property IOSTANDARD LVCMOS33 [get_ports CRE_SDRAM]
#Bank = 15, Pin name = IO_L15P_T2_DQS_15,					Sch name = CRAM_OEN
set_property PACKAGE_PIN H14 [get_ports OE_SDRAM]					
	set_property IOSTANDARD LVCMOS33 [get_ports OE_SDRAM]
#Bank = 14, Pin name = IO_0_14,								Sch name = CRAM_WEN
set_property PACKAGE_PIN R11 [get_ports WE_SDRAM]					
	set_property IOSTANDARD LVCMOS33 [get_ports WE_SDRAM]
#Bank = 15, Pin name = IO_L24N_T3_RS0_15,					Sch name = CRAM_LBN
set_property PACKAGE_PIN J15 [get_ports LB_SDRAM]					
	set_property IOSTANDARD LVCMOS33 [get_ports LB_SDRAM]
#Bank = 15, Pin name = IO_L17N_T2_A25_15,					Sch name = CRAM_UBN
set_property PACKAGE_PIN J13 [get_ports UB_SDRAM]					
	set_property IOSTANDARD LVCMOS33 [get_ports UB_SDRAM]
#Bank = 14, Pin name = IO_L14P_T2_SRCC_14,					Sch name = CRAM_WAIT
set_property PACKAGE_PIN T14 [get_ports WAIT_SDRAM]					
	set_property IOSTANDARD LVCMOS33 [get_ports WAIT_SDRAM]
